if __name__ == "__main__":
    ...
    experiment = CoxPH_TabPFN_embeddings.create(
        param_grid_cox,
        n_iter=grid_search,
        path="/vol/miltank/users/frou/Documents/TFM_for_medical_prognosis/Results/{}_TabPFN_coxph".format(dataset),
    ...
    # print ("*********************these are evaluation parameters : *********************************************\n")
    ...
    # print ("*********************these are evaluations parameters : *********************************************\n")