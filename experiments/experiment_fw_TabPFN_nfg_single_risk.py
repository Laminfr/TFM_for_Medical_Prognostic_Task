if __name__ == "__main__":
    ...
    from experiments.experiment import NFG_TabPFN_embeddings_Experiment
    ...
    experiment = NFG_TabPFN_embeddings_Experiment.create(
        param_grid,
        n_iter=grid_search,
        path="/vol/miltank/users/frou/Documents/TFM_for_medical_prognosis/Results/{}_TabPFN_nfg".format(dataset),
