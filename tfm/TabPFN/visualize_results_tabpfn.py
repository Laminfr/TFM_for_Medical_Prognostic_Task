...
# CONFIGURATION
# ==========================================
RESULTS_DIR = Path('/vol/miltank/users/frou/Documents/TFM_for_medical_prognosis/NeuralFineGray/experiments/TabPFN_results')
OUTPUT_FILE = RESULTS_DIR / 'TabPFN_benchmark_chart.png'
